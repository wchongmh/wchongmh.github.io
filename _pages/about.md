...
<div class="future-goals-section mb-5">
  <div class="section-header d-flex align-items-center mb-4">
    <h2 class="mb-0"><i class="fas fa-binoculars me-3 text-primary"></i>Looking Ahead</h2>
  </div>
  
  <div class="vision-statement p-4 mb-4 rounded-4 bg-light bg-opacity-10 border-start border-4 border-primary">
    <p class="lead mb-0">
      My passion is driven by the aspiration to become a <strong>professional Building Services Engineer</strong>, 
      eager to tackle complex challenges and contribute to global progress through <strong>innovative, 
      forward-thinking solutions</strong>. I am dedicated to advancing sustainable building practices by 
      integrating <strong>AI, IoT, and renewable energy systems</strong> to transcend conventional engineering approaches.
    </p>
  </div>
...
<div class="row g-4 mt-2">
  <div class="col-md-4 text-center">
    <div class="p-3 border rounded h-100 bg-light">
      ...
      <h5>Passive Design First</h5>
      <p>Natural ventilation & daylighting strategies</p>
    </div>
  </div>
  <div class="col-md-4 text-center">
    <div class="p-3 border rounded h-100 bg-light">
      <i class="fas fa-bolt fa-3x text-warning mb-3"></i>
      <h5>Active Efficiency</h5>
      <p>IoT-driven energy optimization systems</p>
    </div>
  </div>
  <div class="col-md-4 text-center">
    <div class="p-3 border rounded h-100 bg-light">
      <i class="fas fa-sun fa-3x text-danger mb-3"></i>
      <h5>Renewable Integration</h5>
      <p>Smart grid & photovoltaic solutions</p>
    </div>
  </div>
</div>
...
<div class="future-goals-section py-5 px-3 px-md-5 bg-light">
    <div class="container">
        ...
        <div class="text-center mb-5">
            <span class="badge bg-primary bg-opacity-10 text-primary fs-6 mb-3 px-4 py-2 rounded-pill">
                <i class="fas fa-binoculars me-2"></i>LOOKING AHEAD
            </span>
            <h2 class="display-5 fw-bold mb-3">Future Goals & Professional Journey</h2>
                    ...
                    <div class="card-header bg-gradient-primary text-white py-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span class="badge bg-white text-primary rounded-pill">5-Year Plan</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress bg-primary bg-opacity-10" style="height: 8px;">
                                <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" 
                                     style="width: 20%"></div>
                            </div>
                            <small class="text-muted mt-2 d-block">Estimated: 2028-2029</small>
                        </div>
                    ...
                    <div class="card-header bg-gradient-success text-white py-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span class="badge bg-white text-success rounded-pill">Structured Learning</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-header bg-gradient-info text-white py-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span class="badge bg-white text-info rounded-pill">Career Growth</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
