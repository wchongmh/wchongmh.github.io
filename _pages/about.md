...
<style>
  ...
  :root {
    ...
    --passive-color: #27ae60;  /* Deep green */
    --active-color: #2980b9;   /* Ocean blue */
    --renewable-color: #f39c12; /* Sun orange */
    --neuro-color: #8e44ad;    /* Creative purple */
    
    /* Soft backgrounds */
    --soft-passive: rgba(39, 174, 96, 0.08);
    --soft-active: rgba(41, 128, 185, 0.08);
    --soft-renewable: rgba(243, 156, 18, 0.08);
    --soft-neuro: rgba(142, 68, 173, 0.08);
  ...
  .header-divider {
    width: 100px;
    height: 4px;
    background: linear-gradient(90deg, var(--passive-color), var(--active-color), var(--renewable-color));
    border-radius: 2px;
    opacity: 0.8;
  }
  ...
  /* Intro Text */
  .intro-text {
    background: linear-gradient(to right, var(--soft-passive), white);
    border-left-color: var(--passive-color) !important;
  }
  ...
  .renewable-integration .pillar-icon {
    color: white;
    background: var(--renewable-color);
  }
  ...
  /* Neurodiversity Card */
  .neurodiversity-card {
    background: linear-gradient(to right, var(--soft-neuro), white);
    border-left: 4px solid var(--neuro-color) !important;
  }
  
  .neuro-icon {
    color: white !important;
    background: var(--neuro-color) !important;
    font-size: 1.8rem;
    width: 60px;
    height: 60px;
    display: flex;
