  ...
  <div class="project-visualization">
    ...
    <div class="visualization-images">
      <div class="visualization-card">
        <img src="/assets/img/projects/electrical/cheuk_nang-2.jpg" 
             alt="Building Exterior Rendering" 
             class="visualization-img"
             loading="lazy">
        <p class="visualization-caption">Building exterior showing service entry points</p>
      </div>
      <div class="visualization-card">
        <img src="/assets/img/projects/electrical/cheuk_nang-3.jpg" 
             alt="Electrical Room Layout" 
             class="visualization-img"
             loading="lazy">
        <p class="visualization-caption">Typical electrical room arrangement</p>
      </div>
    </div>
  </div>
    ...
    <div class="image-comparison">
      <div class="image-card">
        <div class="image-wrapper">
          <img src="/assets/img/projects/electrical/cheuk_nang-4.jpg" 
               alt="Floor Plan Distribution" 
               class="project-image"
               loading="lazy">
        ...
        <div class="image-meta">
          ...
          <span class="image-desc">Typical office floor electrical distribution</span>
        </div>
      </div>
      
      <div class="image-card">
        <div class="image-wrapper">
          <img src="/assets/img/projects/electrical/cheuk_nang-5.jpg" 
    ...
    <div class="calculation-gallery">
      <div class="calculation-item">
        <div class="calc-image-container">
          <img src="/assets/img/projects/electrical/load_calc-1.jpg" 
      ...
      <div class="calculation-item">
        <div class="calc-image-container">
          <img src="/assets/img/projects/electrical/cable_calc-1.jpg" 
               alt="Cable Sizing" 
               class="calc-image"
               loading="lazy">
          <div class="calc-overlay">
  ...
  <section class="project-section reflection-section">
    ...
    <div class="reflection-content">
      ...
      <div class="reflection-image">
        <img src="/assets/img/projects/electrical/coordination-1.jpg" 
             alt="System Coordination Meeting" 
             class="reflection-img"
             loading="lazy">
        <p class="image-caption">Fig 3. Design coordination for electrical/mechanical interfaces</p>
      </div>
    </div>
  </section>
</div>
