...
<div class="energy-analysis-project">
  ...
  <div class="project-container">
    ...
    <div class="project-visualization card">
      <div class="card-content">
    ...
    <section class="project-section overview-section card">
      <div class="card-content">
    ...
    <section class="project-section fabric-section card">
      <div class="card-content">
        <h2 class="section-header">
        ...
        <article class="design-subsection">
          ...
          <div class="performance-grid">
            <div class="performance-item card">
              <h4>Walls</h4>
              <ul>
          ...
          <div class="heat-loss-chart card">
            ...
            <div class="room-comparison card">
    ...
    <section class="project-section hvac-section card">
      <div class="card-content">
        <h2 class="section-header">
        ...
        <article class="design-subsection">
          ...
          <div class="ventilation-design">
            ...
            <div class="ventilation-specs card">
    ...
    <section class="project-section boiler-section card">
      <div class="card-content">
        <h2 class="section-header">
        ...
        <div class="calculation-steps">
          ...
          <div class="calculation-step highlight card">
    ...
    <!-- Conclusions Section -->
    <section class="project-section conclusions-section card">
      <div class="card-content">
        <h2 class="section-header">
...
.system-specs ul, .ventilation-specs ul {
  padding-left: 20px;
}

.system-specs li, .ventilation-specs li {
  margin-bottom: 10px;
  line-height: 1.5;
}
