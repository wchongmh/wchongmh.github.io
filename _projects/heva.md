...
<div class="energy-analysis-container">
  ...
  <section class="project-hero">
    <div class="hero-content">
      <h1 class="hero-title">Two-Story Building Energy Analysis</h1>
      <p class="hero-subtitle">Glasgow Office Building</p>
      <div class="hero-meta">
        <span class="category-badge">Building Systems</span>
    ...
    <div class="hero-visual">
      <img src="/assets/img/projects/glasgow-office/hevacomp-1.png" alt="Hevacomp Software" class="hero-software-logo">
      <p class="hero-description">Modern two-story design with integrated HVAC systems analyzed for energy efficiency</p>
    </div>
  </section>
    ...
    <div class="plans-container">
      <div class="plan-card">
        <img src="/assets/img/projects/glasgow-office/hevacomp-2.png" 
             ...
             class="plan-image"
             loading="lazy">
        <div class="plan-caption">Ground floor plan layout</div>
      </div>
      <div class="plan-card">
        <img src="/assets/img/projects/glasgow-office/hevacomp-3.png" 
             ...
             class="plan-image"
             loading="lazy">
        <div class="plan-caption">First floor plan layout</div>
      </div>
    </div>
  </section>
      ...
      <div class="visual-comparison">
        <div class="visual-card">
          ...
          <div class="image-info">
            ...
            <span class="figure-description">3D view showing building orientation and window placement</span>
          </div>
        </div>
        ...
        <div class="visual-card">
          ...
          <div class="image-info">
            <span class="figure-label">Fig 2.</span>
            <span class="figure-description">Building fabric components and insulation details</span>
          </div>
        </div>
      </div>
      ...
      <div class="specs-highlight">
        ...
        <div class="specs-grid">
          ...
          <div class="spec-item">
            ...
            <div class="spec-label">Rooms</div>
          </div>
          <div class="spec-item">
            <div class="spec-value">15m</div>
            <div class="spec-label">Height</div>
          </div>
          <div class="spec-item">
            <div class="spec-value">75.7kW</div>
            <div class="spec-label">Boiler Capacity</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="content-section">
    <div class="section-header">
      ...
      <h2>Building Fabric Analysis</h2>
    </div>
    
    <div class="section-content">
      <p class="intro-text">The building fabric was carefully designed to meet Scottish building regulations with U-values below 0.3 W/m²K for walls and 0.2 W/m²K for roof/floor. Special attention was given to window design and airtightness to minimize heat loss.</p>

      <div class="subsection">
        <h3 class="subsection-title">Thermal Performance</h3>
        ...
        <div class="performance-grid">
          <div class="performance-card">
            ...
            <div class="performance-images">
              <img src="/assets/img/projects/glasgow-office/hevacomp-10.png" alt="Wall U-value Regulations" class="feature-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-11.png" alt="Wall Standards" class="feature-image">
            </div>
          </div>
          ...
          <div class="performance-card">
            ...
            <div class="performance-images">
              <img src="/assets/img/projects/glasgow-office/hevacomp-6.png" alt="Window Details" class="feature-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-7.png" alt="Window Calculations" class="feature-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-8.png" alt="Window Standards" class="feature-image">
            </div>
          </div>
          ...
          <div class="performance-card">
            ...
            <div class="performance-images">
              <img src="/assets/img/projects/glasgow-office/hevacomp-5.png" alt="Airtightness Standards" class="feature-image">
            </div>
          </div>
        </div>
        ...
        <div class="chart-display">
          ...
          <div class="chart-info">
            <span class="figure-label">Fig 3.</span>
            <span class="figure-description">Heat loss distribution showing 38% infiltration and 28% glazing losses</span>
          </div>
          ...
          <div class="visual-comparison">
            <div class="visual-card">
              <img src="/assets/img/projects/glasgow-office/hevacomp-13.png" 
                   ...
                   loading="lazy">
              <div class="image-info">
                <span class="figure-label">Fig 4.</span>
                <span class="figure-description">Summary of heat losses for all rooms</span>
              </div>
            </div>
            <div class="visual-card">
              <img src="/assets/img/projects/glasgow-office/hevacomp-14.png" 
                   ...
                   loading="lazy">
              <div class="image-info">
                <span class="figure-label">Fig 5.</span>
                <span class="figure-description">Heat loss requirements and regulations</span>
              </div>
            </div>
          </div>
          ...
          <div class="visual-comparison">
            <div class="visual-card">
              <img src="/assets/img/projects/glasgow-office/hevacomp-16.png" 
                   ...
                   loading="lazy">
              <div class="image-info">
                <span class="figure-label">Fig 6.</span>
                <span class="figure-description">Heat loss data for Room 0-1 (Ground Floor)</span>
              </div>
            </div>
            <div class="visual-card">
              <img src="/assets/img/projects/glasgow-office/hevacomp-17.png" 
                   ...
                   loading="lazy">
              <div class="image-info">
                <span class="figure-label">Fig 7.</span>
                <span class="figure-description">Heat loss data for Room 1-4 (First Floor)</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="content-section">
    ...
    <div class="section-content">
      <p class="intro-text">The heating and ventilation systems were designed to provide optimal comfort while minimizing energy consumption. The design includes a Low Temperature Hot Water (LTHW) heating system with CARADON STELRAD Elite K2 radiators and a mechanical ventilation system with heat recovery.</p>

      <div class="subsection">
        <h3 class="subsection-title">Heating System</h3>
          ...
          <div class="system-visuals">
            <div class="system-image">
              ...
              <div class="system-caption">
                <span class="figure-label">Fig 8.</span>
                <span class="figure-description">Radiator layout in the heating system (Ground Floor)</span>
              </div>
            </div>
            ...
            <div class="system-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-25.png" 
                   ...
                   loading="lazy">
              <div class="system-caption">
                <span class="figure-label">Fig 9.</span>
                <span class="figure-description">Isometric view of LTHW heating systems</span>
              </div>
            </div>
          </div>
      ...
      <div class="subsection">
        <h3 class="subsection-title">Ventilation System</h3>
          ...
          <div class="system-visuals">
            <div class="system-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-35.png" 
                   ...
                   loading="lazy">
              <div class="system-caption">
                <span class="figure-label">Fig 10.</span>
                <span class="figure-description">Plan view of overall ventilation system (Supply & Extract)</span>
              </div>
            </div>
            ...
            <div class="system-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-36.png" 
                   ...
                   loading="lazy">
              <div class="system-caption">
                <span class="figure-label">Fig 11.</span>
                <span class="figure-description">Isometric view of supply ductwork system (Ground Floor)</span>
              </div>
            </div>
            ...
            <div class="system-image">
              <img src="/assets/img/projects/glasgow-office/hevacomp-42.png" 
                   ...
                   loading="lazy">
              <div class="system-caption">
                <span class="figure-label">Fig 12.</span>
                <span class="figure-description">Isometric view of extract ductwork system (Ground Floor)</span>
              </div>
            </div>
          </div>
  ...
  <section class="content-section">
    <div class="section-header">
      ...
      <h2>Boiler Sizing Calculations</h2>
    </div>
    
    <div class="section-content">
      <p class="intro-text">The boiler was sized to meet both the LTHW heating demand and ventilation preheat requirements, accounting for system efficiency and heat recovery.</p>
      
      <div class="calculation-flow">
        <div class="calculation-step">
          <h3 class="step-title">LTHW Heating Demand</h3>
          <div class="step-result">40,228 W</div>
        </div>
        
        <div class="calculation-arrow">↓</div>
        
        <div class="calculation-step">
          <h3 class="step-title">Ventilation Preheat</h3>
          <div class="step-details">
            <p>Mass flow rate: 1.9008 kg/s</p>
            <p>ΔT: 24K</p>
            <div class="step-result">27,918 W (after 40% recovery)</div>
          </div>
        </div>
        ...
        <div class="calculation-step">
          <h3 class="step-title">Total Demand</h3>
          <div class="step-result">68,146 W</div>
        </div>
        
        <div class="calculation-arrow">↓</div>
        
        <div class="calculation-step highlight">
          <h3 class="step-title">Boiler Size (90% efficiency)</h3>
          <div class="step-result">75,718 W (75.7 kW)</div>
        </div>
      </div>
      ...
      <div class="boiler-visual">
        ...
        <div class="boiler-caption">
          <span class="figure-label">Fig 13.</span>
          <span class="figure-description">Boiler arrangement with flow temp 75°C & return temp 65°C</span>
        </div>
        ...
        <div class="visual-comparison">
          <div class="visual-card">
            <img src="/assets/img/projects/glasgow-office/hevacomp-27.png" 
                 ...
                 loading="lazy">
            <div class="image-info">
              <span class="figure-label">Fig 14.</span>
              <span class="figure-description">Heating pipe system for boiler</span>
            </div>
          </div>
          <div class="visual-card">
            <img src="/assets/img/projects/glasgow-office/hevacomp-28.png" 
                 ...
                 loading="lazy">
            <div class="image-info">
              <span class="figure-label">Fig 15.</span>
              <span class="figure-description">Heating pump specifications</span>
            </div>
          </div>
        </div>
        ...
        <div class="visual-comparison">
          <div class="visual-card">
            <img src="/assets/img/projects/glasgow-office/hevacomp-29.png" 
                 ...
                 loading="lazy">
            <div class="image-info">
              <span class="figure-label">Fig 16.</span>
              <span class="figure-description">Pipework quantities for boiler system</span>
            </div>
          </div>
          <div class="visual-card">
            <img src="/assets/img/projects/glasgow-office/hevacomp-30.png" 
                 ...
                 loading="lazy">
            <div class="image-info">
              <span class="figure-label">Fig 17.</span>
              <span class="figure-description">Data input for heating pipe system</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="section-content">
      <div class="conclusions-grid">
        <div class="findings-block">
          <h3 class="block-title">Key Findings</h3>
        ...
        <div class="recommendations-block">
          <h3 class="block-title">Improvement Recommendations</h3>
          <div class="recommendation-item">
            <div class="rec-icon">🔄</div>
            <p class="rec-text">Install thermostatic radiator valves (TRVs) for better control</p>
          </div>
          <div class="recommendation-item">
            <div class="rec-icon">💨</div>
            <p class="rec-text">Increase supply and extract duct sizes for improved ventilation</p>
          </div>
          <div class="recommendation-item">
            <div class="rec-icon">🧊</div>
            <p class="rec-text">Enhance insulation to reduce infiltration losses</p>
          </div>
          <div class="recommendation-item">
            <div class="rec-icon">☀️</div>
            <p class="rec-text">Consider heat recovery ventilation system upgrades</p>
          </div>
...
.calculation-step.highlight .step-title,
.calculation-step.highlight .step-result {
  color: var(--white);
}
