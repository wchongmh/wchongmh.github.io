...
image: /assets/img/projects/library-iaq/iehvac-11.png
importance: 2
---
  ...
  <section class="project-section calculations-section">
      ...
      <div class="system-arrangement">
        <div class="arrangement-image">
          ...
          <div class="arrangement-caption">
            ...
            <span class="arrangement-desc">Psychrometric analysis for heat recovery system</span>
          </div>
        </div>
      ...
      <div class="calculation-item">
        <div class="calc-image-container">
          ...
          <div class="calc-overlay">
            ...
            <span class="calc-detail">Friction chart for main ducts</span>
          </div>
        </div>
      </div>
      ...
      <div class="calculation-item">
        <div class="calc-image-container">
          <img src="/assets/img/projects/library-iaq/iehvac-32.png" 
               alt="Energy savings calculation" 
               class="calc-image"
               loading="lazy">
          <div class="calc-overlay">
            <span class="calc-title">Energy Savings</span>
            <span class="calc-detail">Mass flow rate and capacity</span>
          </div>
        </div>
      </div>
      ...
      <div class="calculation-item">
        <div class="calc-image-container">
          <img src="/assets/img/projects/library-iaq/iehvac-34.png" 
               ...
               loading="lazy">
          <div class="calc-overlay">
            <span class="calc-title">Payback Period</span>
            <span class="calc-detail">1.49 year return on investment</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="calculation-summary">
      ...
      <div class="reference-images">
        <img src="/assets/img/projects/library-iaq/iehvac-36.png" alt="FCU Catalog">
        <img src="/assets/img/projects/library-iaq/iehvac-37.png" alt="Acceptable range verification">
      </div>
    </div>
  </section>
    ...
    <div class="reflection-content">
      ...
      <div class="reflection-image">
        <img src="/assets/img/projects/library-iaq/iehvac-38.png" 
             ...
             loading="lazy">
        <p class="image-caption">Final duct sizing implementation plan</p>
      </div>
    </div>
  </section>
</div>
