...
<div class="daylight-project">
    ...
    <div class="key-specs">
      ...
      <div class="specs-grid">
        ...
        <div class="spec-item">
          ...
          <span class="spec-label">Energy Saved</span>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="project-highlights">
    <div class="highlight-card">
      ...
      <div class="highlight-content">
        <span class="highlight-value">180m²</span>
        <span class="highlight-label">Total Area</span>
      </div>
    </div>
    <div class="highlight-card">
      <div class="highlight-icon">🪟</div>
      <div class="highlight-content">
        <span class="highlight-value">8</span>
  ...
  <section class="project-section luminaire-selection">
    ...
    <div class="luminaire-intro">
      <p>The lighting design incorporates a variety of luminaires selected for their energy efficiency, appropriate light distribution, and compliance with the project requirements. The following diagrams show the luminaire distribution across different rooms.</p>
    </div>
    
    <div class="luminaire-grid">
      <div class="luminaire-card">
        <img src="/assets/img/projects/daylight-design/dialux_daylight-15.jpg" 
             alt="Luminaire Distribution Part 1" 
             loading="lazy">
      </div>
      <div class="luminaire-card">
        <img src="/assets/img/projects/daylight-design/dialux_daylight-16.jpg" 
             alt="Luminaire Distribution Part 2" 
             loading="lazy">
      </div>
    </div>
  ...
  <section class="project-section manual-calculations">
    ...
    <article class="calculation-example">
      ...
      <div class="calculation-steps">
        <img src="/assets/img/projects/daylight-design/dialux_daylight-65.jpg" 
             alt="Kitchen Surface Area" 
             loading="lazy">
        <img src="/assets/img/projects/daylight-design/dialux_daylight-66.jpg" 
  ...
  <section class="project-section dialux-simulations">
    ...
    <div class="simulation-intro">
      <p>Advanced Dialux simulations were conducted to validate manual calculations and provide more detailed analysis of daylight distribution and artificial lighting performance throughout the property.</p>
    </div>
    
    <article class="simulation-results">
      <h3 class="subsection-header">Average Daylight Factors</h3>
      <div class="simulation-grid">
        <div class="simulation-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-83.jpg" 
               alt="Lounge Daylight Factors" 
               loading="lazy">
          <p>Ground Floor Lounge</p>
        </div>
        <div class="simulation-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-84.jpg" 
               alt="Cloak Daylight Factors" 
               loading="lazy">
          <p>Ground Floor Cloak</p>
        </div>
        <div class="simulation-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-85.jpg" 
               alt="Kitchen Daylight Factors" 
               loading="lazy">
          <p>Kitchen & Dining</p>
        </div>
        <div class="simulation-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-86.jpg" 
    ...
    <article class="point-analysis">
      ...
      <div class="point-analysis-grid">
        ...
        <div class="point-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-109.jpg" 
               alt="Kitchen Washbasin" 
               loading="lazy">
          <p>Kitchen Washbasin - 13% DF</p>
        </div>
        <div class="point-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-115.jpg" 
               alt="Bathroom Toilet" 
               loading="lazy">
          <p>Bathroom Toilet - 5.06% DF</p>
        </div>
        <div class="point-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-106.jpg" 
    ...
    <article class="surface-analysis">
      <h3 class="subsection-header">Surface Daylight Analysis</h3>
      <div class="surface-grid">
        ...
        <div class="surface-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-139.jpg" 
               alt="Dining Table" 
               loading="lazy">
          <p>Dining Table - 3.55% DF</p>
        </div>
        <div class="surface-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-143.jpg" 
               alt="Bedroom 1 Bed" 
               loading="lazy">
          <p>Bedroom 1 Bed - 5.56% DF</p>
        </div>
        <div class="surface-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-145.jpg" 
  ...
  <section class="project-section energy-analysis">
    ...
    <div class="energy-savings">
      ...
      <div class="savings-card">
        <div class="savings-value">225.02 kWh/a</div>
        <div class="savings-label">Annual Energy Savings</div>
  ...
  <section class="project-section recommendations">
    ...
    <div class="recommendations-intro">
      <p>Based on the analysis, several recommendations are proposed to improve daylight utilization, enhance safety, and optimize energy efficiency throughout the property.</p>
    </div>
    ...
    <div class="recommendations-grid">
      <div class="recommendation-card">
        ...
        <img src="/assets/img/projects/daylight-design/dialux_daylight-178.jpg" 
             alt="Trip Hazard Example" 
             loading="lazy">
        <ul>
          <li>Install anti-slip measures in low-DF areas</li>
          <li>Add supplemental lighting in threshold areas</li>
          <li>Consider motion-activated lighting for safety</li>
        </ul>
      </div>
      ...
      <div class="recommendation-card">
        ...
        <img src="/assets/img/projects/daylight-design/dialux_daylight-180.jpg" 
             ...
             loading="lazy">
        <ul>
          <li>Implement light shelves in south-facing rooms</li>
          <li>Use higher reflectance surfaces in low-DF areas</li>
          <li>Consider daylight redirecting films</li>
        </ul>
      </div>
