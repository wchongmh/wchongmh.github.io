...
<div class="daylight-project">
  ...
  <section class="project-section overview-section">
    ...
    <div class="project-description">
      <p>The daylight analysis focused on a two-story semi-detached house featuring an open-concept living/dining area, three bedrooms, and multiple bathrooms. The study compared manual Daylight Factor calculations with Dialux simulations to evaluate compliance with UK daylight standards and identify areas needing artificial lighting supplementation.</p>
    </div>
      ...
      <div class="background-images">
        <div class="background-image-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-3.png" 
               ...
               loading="lazy">
          <p class="background-caption">Location map</p>
        </div>
        <div class="background-image-card">
          <img src="/assets/img/projects/daylight-design/dialux_daylight-4.png" 
               ...
               class="background-img"
               loading="lazy">
          <p class="background-caption">Street view</p>
        </div>
      </div>
    </div>
  ...
  <section class="project-section standards-section">
    ...
    <div class="standards-intro">
      <p>The design follows UK lighting standards including BS EN 17037 for daylight and BS EN 12464-1 for illuminance levels. Key requirements include:</p>
    </div>
    
    <div class="standards-grid">
      <div class="standard-card">
        <h3>Daylight Factors</h3>
        <ul>
          <li>Minimum 2% average DF for daylit ambiance</li>
          <li>5% average DF for daylight autonomy</li>
        </ul>
      ...
      <div class="standard-card">
        ...
        <ul>
          <li>Living rooms: ≥200 lux</li>
          <li>Bedrooms: ≥100 lux</li>
          <li>Kitchens: ≥500 lux</li>
          <li>Bathrooms: ≥200 lux</li>
        </ul>
  ...
  <section class="project-section methodology-section">
    ...
    <div class="methodology-intro">
      <p>The analysis employed two complementary approaches to evaluate daylight performance:</p>
    </div>
    
    <div class="methodology-approaches">
      <div class="approach-card">
        <h3>Manual Calculations</h3>
        <p>Daylight Factor equations considering:</p>
        <ul>
          <li>Room geometry and window dimensions</li>
          <li>Surface reflectance values</li>
          <li>External obstructions</li>
          <li>Glasgow's overcast sky conditions</li>
        </ul>
      ...
      <div class="approach-card">
        <h3>Dialux Simulations</h3>
        <p>Comprehensive 3D modeling providing:</p>
        <ul>
          <li>Point-by-point daylight analysis</li>
          <li>Surface daylight factors</li>
          <li>Illuminance distribution</li>
          <li>Energy consumption estimates</li>
        </ul>
        <img src="/assets/img/projects/daylight-design/dialux_daylight-100.png" 
             alt="Dialux Simulation Example"
             loading="lazy">
      </div>
    </div>
  ...
  <section class="project-section results-section">
    ...
    <div class="results-intro">
      <p>The analysis revealed varying daylight performance across different rooms, with most spaces meeting minimum requirements but showing opportunities for optimization.</p>
    </div>
    
    <div class="results-comparison">
      <h3 class="subsection-header">Manual vs. Dialux Comparison</h3>
      ...
      <div class="comparison-notes">
        ...
        <ul>
          <li>Bedroom 1 performed best (16.28% manual, 3.79% Dialux)</li>
          <li>Cloakroom performed worst (0.76% manual, 0.72% Dialux)</li>
          <li>Bathroom only failed manual calculation (0.66%)</li>
          <li>Significant differences between methods due to Dialux's detailed modeling</li>
        </ul>
      </div>
    </div>
    
    <div class="illuminance-results">
      <h3 class="subsection-header">Illuminance Levels</h3>
      <img src="/assets/img/projects/daylight-design/dialux_daylight-91.png" 
           alt="Illuminance Results Table"
           loading="lazy">
      <div class="illuminance-notes">
        <p><strong>Compliance Analysis:</strong></p>
        <ul>
          <li>Only Bedroom 1 met recommended illuminance levels (158 lux)</li>
          <li>Kitchen fell short of 500 lux requirement (96 lux)</li>
          <li>Living areas averaged 101 lux (below 150 lux target)</li>
        </ul>
      </div>
    </div>
    
    <div class="detailed-results">
      <h3 class="subsection-header">Detailed Point Analysis</h3>
      
      <div class="point-analysis">
        <h4>Ground Floor Lounge</h4>
        <div class="point-images">
          <div class="point-image-card">
            <img src="/assets/img/projects/daylight-design/dialux_daylight-101.png" 
                 alt="Lounge Table Far"
                 loading="lazy">
            <p>Table far from window: 0.82% DF</p>
          </div>
          <div class="point-image-card">
            <img src="/assets/img/projects/daylight-design/dialux_daylight-103.png" 
                 alt="Lounge Table Close"
                 loading="lazy">
            <p>Table near window: 1.18% DF</p>
          </div>
        </div>
      </div>
      
      <div class="point-analysis">
        <h4>Kitchen/Dining Area</h4>
        <div class="point-images">
          <div class="point-image-card">
            <img src="/assets/img/projects/daylight-design/dialux_daylight-108.png" 
                 alt="Kitchen Workbench"
                 loading="lazy">
            <p>Workbench: 1.82% DF</p>
          </div>
          <div class="point-image-card">
            <img src="/assets/img/projects/daylight-design/dialux_daylight-109.png" 
                 alt="Kitchen Washbasin"
                 loading="lazy">
            <p>Washbasin: 13% DF (best)</p>
          </div>
        </div>
      </div>
      
      <div class="point-analysis">
        <h4>First Floor Bedroom 1</h4>
        <div class="point-images">
          <div class="point-image-card">
            <img src="/assets/img/projects/daylight-design/dialux_daylight-112.png" 
                 alt="Bedroom Reading Table"
                 loading="lazy">
            <p>Reading table: 3.9% DF</p>
          </div>
          <div class="point-image-card">
            <img src="/assets/img/projects/daylight-design/dialux_daylight-143.png" 
                 alt="Bedroom Bed"
                 loading="lazy">
            <p>Bed area: 5.56% DF</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="project-section energy-section">
    ...
    <div class="energy-intro">
      <p>Comparison of manual control versus automatic/daylight-dependent lighting systems revealed significant energy savings potential.</p>
    </div>
  ...
  <section class="project-section recommendations-section">
    ...
    <div class="recommendations-grid">
      <div class="recommendation-card">
        ...
        <ul>
          <li>Install anti-slip strips in bathroom/shower areas</li>
          <li>Add motion-activated lighting in transition areas</li>
          <li>Improve lighting at door thresholds and steps</li>
        </ul>
      ...
      <div class="recommendation-card">
        ...
        <ul>
          <li>Consider light shelves for deeper light penetration</li>
          <li>Evaluate window enlargement in poor-performing rooms</li>
          <li>Use daylight redirecting film on select windows</li>
        </ul>
