...
image: /assets/img/projects/ies-section6/ies_coursework-1.png
importance: 1
---
...
<div class="ies-project">
  ...
  <div class="project-visualization">
    <div class="visualization-description">
      <p>This project demonstrates the comprehensive energy compliance assessment for a two-story office building in Glasgow, analyzing and optimizing the building's performance to meet Section 6 of the Scottish Technical Standards (2015-2023).</p>
    </div>
    <div class="visualization-images">
      <div class="visualization-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-2.jpg" 
             alt="IES VE Software Design Process" 
             class="visualization-img"
             loading="lazy">
        <p class="visualization-caption">Design process in IES VE software</p>
      </div>
      <div class="visualization-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-3.png" 
             alt="3D View of Project Building" 
             class="visualization-img"
             loading="lazy">
        <p class="visualization-caption">3D view of the office building</p>
      </div>
    </div>
  </div>
  
  <div class="project-context">
    <p>The project involved detailed energy modeling of a 1,182.07 m² office building in Glasgow (ASHRAE Climate Zone 5A) using IES VE Compliance software. Initial analysis revealed significant non-compliance with Section 6 standards, requiring comprehensive modifications to building fabric, HVAC systems, lighting, and incorporation of renewables to achieve compliance.</p>
  </div>
  ...
  <section class="project-section overview-section">
    ...
    <div class="project-description">
      <p>The building initially failed to meet Section 6 requirements with energy consumption of 232.48 kWh/m² (vs 53.56 kWh/m² limit) and CO₂ emissions of 98.5 kgCO₂/m² (vs 50 kgCO₂/m² limit). Through systematic improvements to air permeability, U-values, HVAC systems, lighting efficiency, and renewable integration, the project achieved full compliance with final emissions of 12.2 kgCO₂/m².</p>
    </div>
      ...
      <div class="image-card">
        <div class="image-wrapper">
          <img src="/assets/img/projects/ies-section6/ies_coursework-39.png" 
               alt="Initial Energy Performance Data" 
               class="project-image"
               loading="lazy">
        ...
        <div class="image-meta">
          ...
          <span class="image-desc">Initial energy performance showing non-compliance</span>
        </div>
      </div>
      ...
      <div class="image-card">
        <div class="image-wrapper">
          <img src="/assets/img/projects/ies-section6/ies_coursework-40.png" 
               alt="Final Energy Performance Data" 
               class="project-image"
               loading="lazy">
          <div class="image-overlay">
            <span class="zoom-icon">🔍</span>
        ...
        <div class="image-meta">
          ...
          <span class="image-desc">Final performance after all improvements</span>
        </div>
      </div>
    </div>
  ...
  <section class="project-section geometry-section">
    ...
    <div class="geometry-intro">
      <p>The building features two main floors (L00 and L01) plus a lobby area (L02), with 22 rooms on the ground floor and 18 on the first floor. The structure uses reinforced concrete with a flat roof and features significant glazing, including a curtain wall on the southwest corner.</p>
    </div>
  ...
  <section class="project-section analysis-section">
    ...
    <div class="analysis-intro">
      <p>The initial energy simulation revealed significant non-compliance across multiple parameters, with CO₂ emissions nearly double the allowable limit and energy consumption over four times the target.</p>
    </div>
    
    <div class="analysis-grid">
      <div class="analysis-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-14.png" 
             alt="Initial Analysis Results" 
             class="analysis-img"
             loading="lazy">
        <div class="analysis-content">
          <h4>Performance Metrics</h4>
          <ul>
            <li>Energy Consumption: 232.48 kWh/m² (vs 53.56 limit)</li>
            <li>CO₂ Emissions: 98.5 kgCO₂/m² (vs 50 limit)</li>
            <li>Average U-value: 0.83 W/m²K (vs 0.27 recommended)</li>
            <li>Air Permeability: 10 m³/hr/m² (vs 5 required)</li>
          </ul>
        </div>
      </div>
      
      <div class="analysis-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-15.png" 
             alt="Initial System Efficiency" 
             class="analysis-img"
             loading="lazy">
        <div class="analysis-content">
          <h4>System Efficiency</h4>
          <p>Original HVAC systems showed poor efficiency:</p>
          <ul>
            <li>Dual-duct VAV in offices and circulation areas</li>
            <li>Induction systems in eating/drinking areas</li>
            <li>No heat recovery mechanisms</li>
          </ul>
        </div>
      </div>
      ...
      <div class="analysis-card">
        ...
        <div class="analysis-content">
          ...
          <p>Building fabric significantly underperformed Section 6 guidance:</p>
          <ul>
            <li>External walls: 0.27 W/m²K (actual) vs 0.21 required</li>
            <li>Internal partitions: 1.79 W/m²K vs 0.44 required</li>
            <li>Exposed floors: 0.22 W/m²K vs 0.17 required</li>
          </ul>
        </div>
      </div>
      ...
      <div class="analysis-card">
        ...
        <div class="analysis-content">
          ...
          <p>Detailed review of all building elements revealed multiple opportunities for improvement in:</p>
          <ul>
            <li>Wall constructions</li>
            <li>Floor assemblies</li>
            <li>Roof systems</li>
            <li>Glazing performance</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="project-section fabric-section">
    ...
    <div class="fabric-intro">
      <p>Comprehensive upgrades to the building envelope achieved the largest single reduction in CO₂ emissions (22.8 kgCO₂/m²) through improved insulation and reduced thermal bridging.</p>
    </div>
  ...
  <section class="project-section hvac-section">
      ...
      <div class="hvac-system">
        <div class="system-card">
          <img src="/assets/img/projects/ies-section6/ies_coursework-20.png" 
               alt="Fan Coil Unit System" 
               class="system-img"
               loading="lazy">
          <div class="system-content">
            <h4>Fan Coil Units</h4>
            <p>Replaced dual-duct VAV and induction systems in offices and eating areas:</p>
            <ul>
              <li>ECM motors for variable speed control</li>
              <li>Both heating and cooling capability</li>
              <li>Precise zone temperature control</li>
              <li>17.7 kgCO₂/m² BER reduction</li>
            </ul>
          </div>
        </div>
        ...
        <div class="system-card">
          <img src="/assets/img/projects/ies-section6/ies_coursework-22.png" 
               alt="Radiator Circuit System" 
               class="system-img"
               loading="lazy">
          <div class="system-content">
            <h4>Radiator Circuits</h4>
            <p>Implemented in changing facilities and toilets:</p>
            <ul>
              <li>Biomass-fueled LTHW boiler (75% efficiency)</li>
              <li>Optimum start/stop controls</li>
              <li>Weather compensation</li>
              <li>9.7 kgCO₂/m² BER reduction</li>
            </ul>
          </div>
        </div>
        ...
        <div class="system-card">
          <img src="/assets/img/projects/ies-section6/ies_coursework-24.png" 
               alt="Dual-duct VAV System" 
               class="system-img"
               loading="lazy">
          <div class="system-content">
            <h4>Dual-duct VAV</h4>
            <p>Optimized for plant rooms and cupboards:</p>
            <ul>
              <li>Thermal wheel heat recovery (75% efficiency)</li>
              <li>Class D ductwork leakage standard</li>
              <li>Specific fan power of 1.5 W/(l/s)</li>
              <li>15.5 kgCO₂/m² BER reduction</li>
            </ul>
          </div>
        </div>
        ...
        <div class="system-card">
          <img src="/assets/img/projects/ies-section6/ies_coursework-27.png" 
               alt="Local Electric Heater System" 
               class="system-img"
               loading="lazy">
          <div class="system-content">
            <h4>Local Electric Heaters</h4>
            <p>For toilets and changing rooms:</p>
            <ul>
              <li>Biomass heat source</li>
              <li>SFP reduced from 2.60 to 1.10</li>
              <li>Class L1 AHU air leakage standard</li>
              <li>15.5 kgCO₂/m² BER reduction</li>
            </ul>
          </div>
        </div>
    ...
    <article class="hvac-subsection">
      ...
      <div class="dhw-system">
        <div class="dhw-image">
          <img src="/assets/img/projects/ies-section6/ies_coursework-29.png" 
               alt="DHW System Efficiency" 
               class="dhw-img"
               loading="lazy">
        </div>
        <div class="dhw-content">
          <ul>
            <li>High-efficiency air source heat pump (91% seasonal efficiency)</li>
            <li>Biogas-fueled with optimum start/stop controls</li>
            <li>Designed for peak occupancy periods</li>
            <li>0.4 kgCO₂/m² BER reduction</li>
          </ul>
        </div>
      </div>
    </article>
  ...
  <section class="project-section lighting-section">
    ...
    <div class="lighting-intro">
      <p>The lighting system redesign achieved a 67% reduction in power density while maintaining adequate illuminance levels throughout the building.</p>
    </div>
    
    <div class="lighting-comparison">
      <div class="lighting-card">
        ...
        <div class="lighting-content">
          ...
          <ul>
            <li>Power density reduced from 18.75 W/m² to 7 W/m²</li>
            <li>Office areas: Photoelectric dimming with back sensors</li>
            <li>Other areas: Manual switching</li>
            <li>Stand-alone sensors with 0.2 W/m² parasitic power</li>
          </ul>
        </div>
      </div>
      ...
      <div class="lighting-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-33.png" 
             alt="Lighting Improvement Results" 
             class="lighting-img"
             loading="lazy">
        <div class="lighting-content">
          <h4>Performance Impact</h4>
          <ul>
            <li>12.5 kgCO₂/m² reduction in BER</li>
            <li>Maintained required illuminance levels</li>
            <li>Significant reduction in energy consumption</li>
            <li>Improved visual comfort for occupants</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="project-section renewables-section">
    ...
    <div class="renewables-intro">
      <p>The final 6.2 kgCO₂/m² reduction needed for compliance was achieved through strategic integration of solar photovoltaic technology.</p>
    </div>
    
    <div class="renewables-system">
      <div class="renewables-image">
        <img src="/assets/img/projects/ies-section6/ies_coursework-34.png" 
             alt="Solar PV System Details" 
             class="renewables-img"
             loading="lazy">
      </div>
      <div class="renewables-content">
        <h4>Solar PV System</h4>
        <ul>
          <li>4 monocrystalline panels (60 m² each)</li>
          <li>South-facing at 30° inclination</li>
          <li>Minimum yield of 850 kWh/kWp/year</li>
          <li>Compliant with IEC 61215 and 61730 standards</li>
          <li>6.2 kgCO₂/m² BER reduction</li>
        </ul>
      </div>
    </div>
    
    <div class="renewables-stats">
      <div class="renewables-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-35.png" 
             alt="Solar Gains Analysis" 
             class="stats-img"
             loading="lazy">
        <p>Solar gains analysis across all zones</p>
      </div>
      <div class="renewables-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-37.png" 
             alt="Energy Production Data" 
             class="stats-img"
             loading="lazy">
      ...
      <div class="renewables-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-38.png" 
             alt="Final Compliance Results" 
             class="stats-img"
             loading="lazy">
        <p>Achieved Section 6 compliance</p>
      </div>
    </div>
  </section>

  <!-- Project Outcomes Section -->
  <section class="project-section outcomes-section">
    <h2 class="section-header">
    ...
    <div class="outcomes-comparison">
      <div class="comparison-item">
        <img src="/assets/img/projects/ies-section6/ies_coursework-39.png" 
             alt="Initial Performance" 
             class="comparison-img"
             loading="lazy">
        <p>Initial Performance</p>
      </div>
      <div class="comparison-item">
        <img src="/assets/img/projects/ies-section6/ies_coursework-40.png" 
