...
<div class="ies-project">
  ...
  <div class="project-visualization">
    <div class="visualization-description">
      <p>This project demonstrates the comprehensive energy analysis and modifications made to a Glasgow office building to achieve compliance with Section 6 of the Scottish Technical Standards. The process involved detailed simulation in IES VE software, building fabric improvements, HVAC system optimization, and renewable energy integration.</p>
    </div>
    <div class="visualization-images">
      <div class="visualization-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-1.png" 
             ...
             loading="lazy">
        <p class="visualization-caption">IES VE Software Interface</p>
      </div>
      <div class="visualization-card">
        <img src="/assets/img/projects/ies-section6/ies_coursework-2.jpg" 
             ...
             class="visualization-img"
             loading="lazy">
        <p class="visualization-caption">Design Working Process</p>
      </div>
    </div>
  </div>
  
  <div class="project-context">
    <p>The project focused on a two-story office and workshop building in Glasgow (ASHRAE Climate Zone 5A) with a total floor area of 1182.07 m². Initial analysis revealed significant non-compliance with Section 6 requirements, particularly in energy consumption (232.48 kWh/m²) and CO₂ emissions (98.5 kgCO₂/m²). Through systematic modifications, the building achieved full compliance with emissions reduced to 12.2 kgCO₂/m².</p>
  </div>
  ...
  <section class="project-section overview-section">
    ...
    <div class="project-description">
      <p>The building energy analysis utilized IES VE Compliance tool to evaluate compliance with Scottish Building Standards Section 6. The project involved multiple stages of modifications including building fabric improvements, HVAC system optimization, lighting upgrades, and renewable energy integration to achieve the required energy performance targets.</p>
    </div>
    ...
    <div class="image-comparison">
      <div class="image-card">
        ...
        <div class="image-meta">
          ...
          <span class="image-desc">3D view of the project building in IES VE</span>
        </div>
      </div>
      ...
      <div class="image-card">
        ...
        <div class="image-meta">
          ...
          <span class="image-desc">Initial analysis showing non-compliance</span>
        </div>
      </div>
    </div>
    ...
    <div class="key-specs">
      ...
      <div class="specs-grid">
        ...
        <div class="spec-item">
          ...
          <span class="spec-label">CO₂ Reduction (kg/m²)</span>
        </div>
        <div class="spec-item">
  ...
  <section class="project-section geometry-section">
    ...
    <div class="geometry-intro">
      <p>The building consists of two main floors (L00 and L01) with 40 rooms serving various functions including offices, testing rooms, eating/drinking areas, and washrooms. The structure features reinforced concrete construction with heavy glazing and a southwest curtain wall.</p>
    </div>
  ...
  <section class="project-section regulations-section">
    ...
    <div class="regulations-content">
      <div class="regulation-card">
        ...
        <ul>
          <li>Annual CO₂ emissions ≤ 50 kgCO₂/m²</li>
          <li>Energy efficiency assessed via National Calculation Methodology</li>
          <li>Minimum thermal performance for building fabric</li>
          <li>Efficient HVAC systems with low-carbon energy sources</li>
          <li>Proper ventilation with minimal energy use</li>
    ...
    <article class="modification-subsection">
      ...
      <div class="modification-content">
        <div class="modification-text">
          ...
          <ul>
            <li>External wall U-value improved from 0.2700 to 0.2093 W/m²K</li>
            <li>Internal partition U-value reduced from 1.7888 to 0.4445 W/m²K</li>
            <li>Exposed floor U-value improved from 0.2200 to 0.1730 W/m²K</li>
            <li>Roof U-value optimized to 0.1800 W/m²K</li>
            <li>Air permeability reduced from 10 to 5 m³/hr/m² at 50 Pa</li>
          </ul>
    ...
    <article class="hvac-subsection">
      ...
      <div class="system-tabs">
        ...
        <div class="tab-content active" id="fan-coil">
          <div class="system-details">
            <div class="system-description">
              <p>Replaced induction systems and dual-duct VAV in office and eating areas with fan coil units featuring ECM motors for better efficiency and control.</p>
              <ul>
                <li>17.7 kgCO₂/m² reduction in BER</li>
                <li>7.3 kgCO₂/m² reduction in TER</li>
                <li>Seasonal efficiency: 0.7</li>
                <li>Equipped with heat recovery (Thermal wheel, 0.75 efficiency)</li>
              </ul>
            </div>
        ...
        <div class="tab-content" id="radiator">
          <div class="system-details">
            <div class="system-description">
              <p>Implemented radiator circuits using water in changing facilities, toilets, and circulation areas for improved energy efficiency.</p>
              <ul>
                <li>9.7 kgCO₂/m² reduction in BER</li>
                <li>0.4 kgCO₂/m² reduction in TER</li>
                <li>Powered by LTHW boiler with biomass fuel</li>
                <li>0.75 generator efficiency</li>
              </ul>
            </div>
            <div class="system-images">
        ...
        <div class="tab-content" id="vav">
          <div class="system-details">
            <div class="system-description">
              <p>Installed dual-duct VAV system in cupboards and plant rooms for precise temperature control.</p>
              <ul>
                <li>15.5 kgCO₂/m² reduction in BER</li>
                <li>0.5 kgCO₂/m² reduction in TER</li>
                <li>Seasonal cooling EER: 2.55</li>
        ...
        <div class="tab-content" id="electric-heater">
          <div class="system-details">
            <div class="system-description">
              <p>Optimized local electric heater mechanical ventilation systems in toilet areas.</p>
              <ul>
                <li>15.5 kgCO₂/m² reduction in BER</li>
                <li>0.5 kgCO₂/m² reduction in TER</li>
                <li>Specific fan power adjusted from 2.60 to 1.10</li>
                <li>Uses "Biomass: Meter 1" as heat source</li>
              </ul>
            </div>
            <div class="system-images">
        ...
        <div class="tab-content" id="dhw">
          <div class="system-details">
            <div class="system-description">
              <p>Implemented efficient DHW system with air source heat pump (seasonal efficiency 0.91).</p>
              <ul>
                <li>0.4 kgCO₂/m² reduction in BER</li>
                <li>Optimized for peak occupancy periods</li>
                <li>Biogas fuel source</li>
                <li>Storage loss factor optimized</li>
              </ul>
            </div>
            <div class="system-images">
      ...
      <div class="lighting-content">
        <div class="lighting-text">
          ...
          <ul>
            ...
            <li>Office areas equipped with photoelectric dimming with back sensor</li>
            <li>Other areas use manual switching</li>
            <li>Parasitic power limited to 0.2 W/m²</li>
          </ul>
  ...
  <section class="project-section renewables-section">
    ...
    <div class="renewables-content">
      <div class="renewables-text">
        <p>To achieve full compliance, the project incorporated monocrystalline silicon PV panels:</p>
        <ul>
          <li>4 PV panels totaling 240 m² (60 m² each)</li>
          <li>South-facing orientation at 30° inclination</li>
          <li>Minimum yield of 850 kWh/kWp per year</li>
          <li>Compliant with IEC 61215 and IEC 61730 standards</li>
          <li>Additional 11.91 kWh/m² energy production</li>
        </ul>
        <p>The PV system provided the final 6.2 kgCO₂/m² reduction needed to achieve compliance.</p>
      </div>
      
      <div class="renewables-images">
        <div class="renewables-image">
          <img src="/assets/img/projects/ies-section6/ies_coursework-34.png" 
               alt="PV System Details" 
               loading="lazy">
          <p>PV system design details</p>
        </div>
        <div class="renewables-image">
          <img src="/assets/img/projects/ies-section6/ies_coursework-35.png" 
               alt="Solar Gains Data" 
               loading="lazy">
          <p>Solar gains across all zones</p>
        </div>
        <div class="renewables-image">
          <img src="/assets/img/projects/ies-section6/ies_coursework-36.png" 
               alt="Alternative Energy Systems" 
               loading="lazy">
          <p>EPBD (Recast) considerations</p>
        </div>
        <div class="renewables-image">
          <img src="/assets/img/projects/ies-section6/ies_coursework-37.png" 
               alt="Energy Production Data" 
               loading="lazy">
          <p>Energy production by technology</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="project-section results-section">
    ...
    <div class="results-content">
      <div class="results-text">
        ...
        <ul>
          <li>Total energy consumption reduced from 232.48 to 83.78 kWh/m² (64% reduction)</li>
          <li>CO₂ emissions reduced from 98.5 to 12.2 kgCO₂/m² (87.6% reduction)</li>
          <li>All U-values meet or exceed Section 6 requirements</li>
          <li>HVAC systems optimized for efficiency and occupant comfort</li>
  ...
  <section class="project-section conclusion-section">
    ...
    <div class="conclusion-content">
      <div class="conclusion-text">
        <p>This project successfully transformed a non-compliant office building into one that fully meets the stringent energy efficiency requirements of Section 6 of the Scottish Technical Standards. Through systematic analysis and targeted modifications across all building systems, the project achieved:</p>
        <ul>
          <li>86.3 kgCO₂/m² reduction in emissions</li>
          <li>148.7 kWh/m² reduction in energy consumption</li>
          <li>Optimized thermal performance through fabric improvements</li>
          <li>Highly efficient HVAC systems tailored to space requirements</li>
          <li>Effective integration of renewable energy sources</li>
        </ul>
...
@media (max-width: 768px) {
  ...
  .specs-grid, .results-grid, .achievements-grid {
...
document.addEventListener('DOMContentLoaded', function() {
  // Handle viewport scaling for mobile
  ...
  // Prevent zooming on pinch gesture for mobile
