...
image: /assets/img/projects/commercial-building/plumbing_fire-1.png
importance: 1
---
  ...
  <section class="project-section reflection-section">
    ...
    <div class="reflection-content">
      <div class="reflection-text">
        <p>This project successfully integrated academic knowledge with practical design requirements for high-rise commercial buildings. The comprehensive systems design addressed all regulatory requirements while optimizing for maintainability and future flexibility.</p>
...
<style>
.commercial-project .system-specs {
  display: grid;
...
.commercial-project .design-notes {
  background: #f9f9f9;
  padding: 15px;
  border-radius: 6px;
  margin-top: 20px;
