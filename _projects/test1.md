...
<div class="plumbing-project">
  ...
  <section class="project-section system-design">
      ...
      <div class="diagram-grid">
        ...
        <div class="diagram-card">
          ...
          <div class="diagram-meta">
            ...
            <span class="diagram-fig">Fig 4. Typical vertical riser diagram showing pipe sizing transitions every 15 floors</span>
          </div>
        </div>
      </div>
    </article>
    ...
    <article class="design-subsection">
      ...
      <div class="arrangement-description">
        <p>The water supply system features a dual-header arrangement with automatic changeover capability to ensure continuous service during maintenance. The design includes strategically located isolation valves to minimize service disruption when repairs are needed.</p>
      </div>
  ...
  <section class="project-section calculations-section">
    ...
    <div class="calculation-gallery">
      ...
      <!-- Additional calculation items with enhanced descriptions -->
